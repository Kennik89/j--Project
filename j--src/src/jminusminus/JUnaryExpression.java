...
class JPositiveOp extends JUnaryExpression {
     ...
     * the operand, and then no instruction.
     * 
     * @param output
     *            the code emitter (basically an abstraction for producing the
     *            .class file).
...
/**
 * The AST node for a unary bnot (~) expression.
 */

class JBNOTOp extends JUnaryExpression {

    /**
     * Construct an AST node for a bnot expression given its line number,
     * and the operand.
     * 
     * @param line
     *            line in which the bnot expression occurs in the source
     *            file.
     * @param arg
     *            the operand.
     */
    ...
    /**
     * Analyzing the bnot operation involves analyzing its operand, checking
     * its type and determining the result type.
     * 
     * @param context
     *            context in which names are resolved.
    ...
    /**
     * Generating code for the bnot operation involves generating code for
     * the operand, and then the negation instruction.
     * 
     * @param output
     *            the code emitter (basically an abstraction for producing the
