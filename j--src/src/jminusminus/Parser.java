...
public class Parser {
    ...
    private JExpression conditionalAndExpression() {
        ...
        while (more) {
            if (have(LAND)) {
                lhs = new JLogicalAndOp(line, lhs, bitwiseIORExpression());
            } else {
                more = false;
            }
        }
    ...
    /**
     * Parse an bitwise IOR expression.
     * 
     * <pre>
     ...
     * </pre>
     * 
     * @return an AST for an bitwiseIORExpression.
     */
    ...
    private JExpression bitwiseIORExpression() {
        ...
        while (more) {
            if (have(BIOR)) {
                lhs = new JBIOROp(line, lhs, bitwiseXORExpression());
            } else {
                more = false;
            }
        }
    ...
    private JExpression bitwiseXORExpression() {
        ...
        while (more) {
            if (have(BXOR)) {
                lhs = new JBXOROp(line, lhs, bitwiseANDExpression());
            } else {
                more = false;
            }
        }
     ...
     *                            {ASL additiveExpression}
     *                            {ASR additiveExpression}
     *                            {LSR additiveExpression}
     * </pre>
     * 
    ...
    private JExpression shiftExpression() {
        ...
        while (more) {
            if (have(ASL)) {
                lhs = new JASLOp(line, lhs, additiveExpression());
            } else if (have(ASR)) {
                lhs = new JASROp(line, lhs, additiveExpression());
            } else if (have(LSR)) {
                lhs = new JLSROp(line, lhs, additiveExpression());
            } else {
                more = false;
            }
        }
