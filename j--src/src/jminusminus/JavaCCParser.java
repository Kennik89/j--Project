...
class JavaCCParser implements JavaCCParserConstants {
    ...
    try {
      ...
      case CLASS:
        jj_consume_token(CLASS);
                          line = token.beginLine; isClass = true;
        break;
      case INTERFACE:
        jj_consume_token(INTERFACE);
                              line = token.beginLine; isClass = false;
        break;
      default:
        jj_la1[6] = jj_gen;
        jj_consume_token(-1);
      ...
      classBody = classBody();
        ...
        {if (true) return new JClassDeclaration( line, mods, isClass,
  ...
  final private JMember memberDecl(ArrayList<String>  mods) throws ParseException {
    ...
    ArrayList<TypeName> idents = null;
    JBlock body = null;
...
<<<<<<< HEAD
        case DOUBLE:
=======
>>>>>>> ed4530bb251ee3cc6c38036435c3d4cea41dc568
        case INT:
        case IDENTIFIER:
          type = type();
          break;
...
>>>>>>> ed4530bb251ee3cc6c38036435c3d4cea41dc568
    ...
    try {
      ...
      case TRY:
        ...
        if (jj_2_7(2147483647)) {
          ...
          statement = new JTryStatement( line, tryBlock, catchClauses, finallyBlock );
        break;
      case SEMI:
        jj_consume_token(SEMI);
  ...
  final private JCatchClause catchClause() throws ParseException {
    int line = 0;
    JFormalParameter catchParameter = null;
    ...
    try {
      ...
      catchBlock = block();
          catchClause = new JCatchClause( line, catchParameter, catchBlock );
    } catch (ParseException e) {
        recoverFromError( new int[] { SEMI, EOF }, e );
    }
      {if (true) return catchClause;}
    throw new Error("Missing return statement in function");
  }
...
<<<<<<< HEAD
  final private JExpression conditionalExpression() throws ParseException {
        int line = 0;
        JExpression test = null, lhs = null, rhs = null;
    try {
      ...
      case QM:
        ...
        rhs = conditionalExpression();
              {if (true) return new JConditionalExpression(line,test,lhs,rhs);}
        break;
      default:
        jj_la1[35] = jj_gen;
        ;
...
>>>>>>> ed4530bb251ee3cc6c38036435c3d4cea41dc568
  ...
  final private JExpression bitwiseIORExpression() throws ParseException {
    int line = 0;
    JExpression lhs = null, rhs = null;
    try {
...
>>>>>>> ed4530bb251ee3cc6c38036435c3d4cea41dc568
        ...
        jj_consume_token(BIOR);
        rhs = bitwiseXORExpression();
              lhs = new JBIOROp( line, lhs, rhs );
      }
    } catch (ParseException e) {
        recoverFromError( new int[] { SEMI, EOF }, e );
    }
  ...
  final private JExpression bitwiseXORExpression() throws ParseException {
    int line = 0;
    JExpression lhs = null, rhs = null;
    try {
...
>>>>>>> ed4530bb251ee3cc6c38036435c3d4cea41dc568
  ...
  final private JExpression bitwiseANDExpression() throws ParseException {
    int line = 0;
    JExpression lhs = null, rhs = null;
    try {
...
>>>>>>> ed4530bb251ee3cc6c38036435c3d4cea41dc568
        ...
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case ASL:
          jj_consume_token(ASL);
          rhs = additiveExpression();
              lhs = new JASLOp( line, lhs, rhs );
          break;
        case ASR:
          jj_consume_token(ASR);
          rhs = additiveExpression();
              lhs = new JASROp( line, lhs, rhs );
          break;
        case LSR:
          jj_consume_token(LSR);
          rhs = additiveExpression();
              lhs = new JLSROp( line, lhs, rhs );
          break;
        default:
<<<<<<< HEAD
          jj_la1[44] = jj_gen;
    ...
    try {
      ...
      case BNOT:
        jj_consume_token(BNOT);
                 line = token.beginLine;
        unaryExpr = unaryExpression();
          expr = new JBNOTOp( line, unaryExpr );
        break;
      case FALSE:
      case NEW:
      case NULL:
...
=======
  final private boolean jj_3R_60() {
    if (jj_scan_token(BIOR)) return true;
...
=======
  final private boolean jj_3R_78() {
    if (jj_scan_token(ASL)) return true;
    if (jj_3R_69()) return true;
>>>>>>> ed4530bb251ee3cc6c38036435c3d4cea41dc568
    return false;
  }
...
<<<<<<< HEAD
      jj_la1_0 = new int[] {0x0,0x40000000,0x4080,0x0,0x80,0x80,0x200000,0x82180,0x0,0x82100,0x0,0x0,0x82100,0x0,0x0,0x10482100,0x10400000,0x400000,0x10400000,0x0,0x82100,0x0,0x0,0x400000,0x0,0x400000,0x0,0x400000,0x82100,0x82100,0x0,0x0,0x82100,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x400000,0x0,0x400000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x400000,0x82100,0x0,0x0,0x0,0x400000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x40,0x0,0x1380,0x0,0x1380,0x1380,0x0,0x801381,0x80000,0x800001,0x80000,0x0,0x1,0x0,0x0,0x86664431,0x86664430,0x84224030,0x86664430,0x0,0x1,0x0,0x8000000,0x84224030,0x0,0x84224030,0x0,0x84224030,0x1,0x1,0x0,0x0,0x1,0x8000000,0x8000000,0x0,0x0,0x0,0x0,0x0,0x20000000,0x40000000,0x40000000,0x0,0x0,0x4000000,0x4000000,0x0,0x0,0x84224030,0x0,0x224030,0x0,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x224030,0x1,0x0,0x0,0x0,0x200020,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4000080c,0x4000080c,0x4000080c,0x4000080c,0x0,0x0,0x0,0x0,0x4000080c,0x0,0x4000080c,0x0,0x4000080c,0x0,0x0,0x0,0x0,0x0,0xf00010,0xf00010,0x8000,0x1,0x1000,0x2000,0x4000,0x0,0x2,0x2,0x700,0x700,0x8,0x8,0xe0,0xe0,0x4000080c,0x4,0x40000000,0x0,0x0,0x40000000,0x0,0x40000000,0x40000000,0x40000000,0x40000000,0x40000000,0x0,0x0,0x40000000,0x0,0x0,};
   }
   private static void jj_la1_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x101,0x0,0x100,0x0,0x11,0x100,0x20,0x100,0xf111,0xf111,0xf100,0xf111,0x20,0x100,0x20,0x0,0xf101,0x20,0xf101,0x20,0xf100,0x0,0x0,0x4,0x4,0x100,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf100,0x0,0xf100,0x44,0x0,0x0,0x44,0x0,0x0,0x40,0x0,0xf100,0x100,0x1,0x0,0x4,0xf000,};
=======
      jj_la1_0 = new int[] {0x0,0x80000000,0x8100,0x0,0x100,0x100,0x8000,0x400000,0x4300,0x0,0x4200,0x0,0x0,0x4200,0x0,0x0,0x20804200,0x20800000,0x800000,0x20800000,0x0,0x4200,0x0,0x0,0x800000,0x0,0x800000,0x0,0x800000,0x4200,0x4200,0x0,0x0,0x4200,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x800000,0x0,0x800000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x800000,0x4200,0x0,0x0,0x0,0x800000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x80,0x0,0x2704,0x0,0x2700,0x2700,0x4,0x0,0x1002702,0x100000,0x1000002,0x100000,0x0,0x2,0x0,0x0,0x2ccc8862,0x2ccc8860,0x28448060,0x2ccc8860,0x0,0x2,0x0,0x10000000,0x28448060,0x0,0x28448060,0x0,0x28448060,0x2,0x2,0x0,0x0,0x2,0x10000000,0x10000000,0x0,0x0,0x0,0x0,0x0,0x40000000,0x80000001,0x80000001,0x0,0x0,0x8000000,0x8000000,0x0,0x0,0x28448060,0x0,0x448060,0x0,0x20000000,0x0,0x0,0x0,0x0,0x0,0x0,0x448060,0x2,0x0,0x0,0x0,0x400040,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80001019,0x80001019,0x80001019,0x80001019,0x0,0x0,0x0,0x0,0x80001019,0x0,0x80001019,0x0,0x80001019,0x0,0x0,0x0,0x0,0x0,0x1e00020,0x1e00020,0x100000,0x2,0x2000,0x4000,0x8000,0x0,0xc0004,0xc0004,0xe00,0xe00,0x10,0x10,0x1c0,0x1c0,0x80001019,0x8,0x80000000,0x0,0x0,0x80000000,0x0,0x80000000,0x80000000,0x80000000,0x80000000,0x80000000,0x0,0x0,0x80000000,0x0,0x0,};
   }
   private static void jj_la1_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x80,0x0,0x0,0x0,0x0,0x202,0x0,0x200,0x0,0x22,0x200,0x40,0x200,0xe222,0xe222,0xe200,0xe222,0x40,0x200,0x40,0x0,0xe202,0x40,0xe202,0x40,0xe200,0x0,0x0,0x8,0x8,0x200,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xe200,0x0,0xe200,0x88,0x0,0x0,0x88,0x0,0x0,0x80,0x0,0xe200,0x200,0x2,0x0,0x8,0xe000,};
>>>>>>> ed4530bb251ee3cc6c38036435c3d4cea41dc568
   }
