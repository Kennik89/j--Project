...
public class JavaCCParserStep3_2Test extends TestCase {

    /**
     * Construct a JavaCCParserTest object.
     */

    public JavaCCParserStep3_2Test() {
    ...
    public void testPass() {
        File passTestsDir = new File(System.getProperty("PASS_TESTS_DIR"), "step2");
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(JavaCCParserStep3_2Test.class);
    }
